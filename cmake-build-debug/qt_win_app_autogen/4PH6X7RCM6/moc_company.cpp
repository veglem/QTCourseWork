...
#include "../../../windows/company/company.h"
...
static constexpr auto qt_meta_stringdata_CLASScompanyENDCLASS = QtMocHelpers::stringData(
    "company",
    "get_project",
    "",
    "edit_company",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASScompanyENDCLASS_t qt_meta_stringdata_CLASScompanyENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 11),  // "get_project"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 12),  // "edit_company"
        QT_MOC_LITERAL(34, 14)   // "delete_company"
    },
    "company",
    "get_project",
    "",
...
void company::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->get_project(); break;
        case 1: _t->edit_company(); break;
        case 2: _t->delete_company(); break;
        default: ;
        }
    }
    (void)_a;
